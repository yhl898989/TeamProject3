...
<table class="order_table">
  ...
  <ul class="pagination nav justify-content-center bg-light">
    <li class="page-item">
      <a class="page-link" href="/admin/orderList?curpage=${pt.curPage <=1? 1: pt.curPage-1}">&laquo;</a>
    </li>
    
    <c:forEach begin="${pt.beginPageNum }" end="${pt.finishPageNum}" var="page">
    	<c:if test="${page == pt.curPage }">
    		  <li class="page-item active" aria-current="page">
			  	  <a class="page-link" href="/admin/orderList?curpage=${pt.curPage }">${page }</a>
		      </li>
    	</c:if>
    	<c:if test="${page != pt.curPage }">
		    <li class="page-item">
		    	<a class="page-link" href="/admin/orderList?curpage=${page }">${page}</a>
		    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="/admin/orderList?curpage=${pt.curPage >= pt.totalPage? pt.curPage:pt.curPage+1 }">&raquo;</a>
    </li>
  </ul>
